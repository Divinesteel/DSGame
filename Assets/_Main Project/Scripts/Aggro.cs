...
public class Aggro : MonoBehaviour {
	...
	void Update () {
        ...
        {
            Debug.Log(Vector3.Angle(transform.forward, startingPosition.forward));
            transform.rotation = Quaternion.Slerp(transform.rotation, startingPosition.rotation, Time.deltaTime * 5); //rotate enemy to initial position
